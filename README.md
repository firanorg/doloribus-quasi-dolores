# @/jsonpath [![CircleCI](https://circleci.com/gh/firanorg/doloribus-quasi-dolores.svg?style=svg)](https://circleci.com/gh/firanorg/doloribus-quasi-dolores) 

[![npm (scoped)](https://img.shields.io/npm/v/@firanorg/doloribus-quasi-dolores?style=flat-square)](https://npmjs.com/package/@firanorg/doloribus-quasi-dolores)
...
```javascript
import { JSONPath } from '@firanorg/doloribus-quasi-dolores';
...
Install from npm:
```bash
$ npm install @firanorg/doloribus-quasi-dolores
```
